  ...
  if (authData) {
    return (
      <div className="px-2 md:p-0">
        <div className="w-[95vw] md:w-screen py-20 flex justify-center flex-col items-center">
          ...
          <h1 className=" text-2xl font-extrabold uppercase mb-5">
            DEPI 2
            <span className="text-orange-700 ml-2">Graduation project </span>
          </h1>
          <div className="flex justify-center flex-col items-center w-[90vw] md:w-[1000px] ">
            <AddTodo />
